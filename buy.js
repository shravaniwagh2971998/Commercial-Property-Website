var newapp=angular.module('companyModelsapp',['ngMaterial','ui.router','ui.bootstrap','ngSanitize','ngMessages']);
newapp.controller('companyCtrl1', ['$scope','$window','$location',function($scope,$window,$location) {
